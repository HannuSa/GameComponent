...
static const GLchar* VERTEX_SOURCE2 = 
...
static const GLchar* FRAGMENT_SOURCE2 =
"void main()\
{\
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	glShaderSource(vertexShaderObject, 1u, &VERTEX_SOURCE2, NULL);

	glShaderSource(fragmentShaderObject, 1u, &FRAGMENT_SOURCE2, NULL);
	...
	*/
	...
	for (;;)
	{
		...
		glVertexAttribPointer(positionIndex, 3, GL_FLOAT, GL_FALSE, 0, reinterpret_cast<GLvoid*>(0));
		//glVertexAttribPointer(textureIndex, 2, GL_FLOAT, GL_FALSE, 0, reinterpret_cast<GLvoid*>(12));
